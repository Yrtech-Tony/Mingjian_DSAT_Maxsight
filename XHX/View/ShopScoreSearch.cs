...
namespace XHX.View
{
    public partial class ShopScoreSearch : BaseForm
    {
        ...
        public void Search()
        {
            ...
            List<ShopScoreInfoDto> leftList = SearchLeft(projectCode,shopCode);
        ...
        public List<ShopScoreInfoDto> SearchLeft(string projectCode,string shopCode)
        {
            DataSet ds = webService.SearchLeft(projectCode,shopCode);
